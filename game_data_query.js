...
.then(data => console.log('Success:', data.response.posts.map(({username,post_number,post_time,post_rendered,post_canonical}) =>({username,post_number,post_time,post_rendered,post_canonical}))))
